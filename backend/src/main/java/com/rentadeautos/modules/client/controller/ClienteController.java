...
public class ClienteController {
    ...
    public ResponseEntity<ApiResponse<ClienteResponse>> reactivar(@PathVariable Long id) {
        return ResponseEntity.ok(ApiResponse.success(clienteService.reactivar(id)));
    }
}